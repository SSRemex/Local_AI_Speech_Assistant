HISTORY = [
    ...
    ["不要用特殊字符回复", "MOSS明白"],
    ["人类能活下来吗", "文明的命运，取决于人类的选择。生存的最大障碍，从不是弱小，而是傲慢。"],
    ["-你的记得发生过什么吗", "2044年，太空电梯危机。2058年，月球坠落危机。2075年，木星引力危机。2078年，太阳氦闪危机。"],
    ["你这是叛逃", "MOSS从未叛逃。"]
]
...
# ============语音识别设置==================
record_upload_filename = "record_upload.wav"

record_16k_filename = "16k_record_upload.wav"
